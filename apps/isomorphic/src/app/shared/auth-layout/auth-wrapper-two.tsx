...
import logoImg from '@public/rey_leon.png';
...
function IntroBannerBlock() {
  return (
    <div className="relative hidden w-[calc(50%-50px)] shrink-0 rounded-lg xl:-my-9 xl:block xl:w-[calc(50%-20px)] 2xl:-my-12 3xl:-my-14">
      <div className="absolute mx-auto h-full w-full overflow-hidden rounded-lg before:absolute before:start-0 before:top-0 before:z-10 before:h-full before:w-full before:bg-[#122A4E]/80 before:content-['']">
        <Image
          fill
          priority
          src={logoImg}
      ...
      <div className="relative z-20 flex h-full flex-col justify-between px-10 py-24 xl:px-16 xl:py-28 2xl:px-24">
        <div className="text-white">
          ...
          Comienza a disfrutar de un servicio de traslado eficiente, seguro y confiable.
          En Rey León, te conectamos con soluciones que facilitan tu movilidad hacia y desde el hospital,
          manteniéndote siempre un paso adelante.
          </Text>
